...
class TestSquare_instantiation(unittest.TestCase):
    """Unittests for testing of Square class instantiation."""
...
class TestSquare_size(unittest.TestCase):
    """Unittests for testing of Square class size initialization."""
...
class TestSquare_stdout(unittest.TestCase):
    ...
    def capture_stdout(sqr, method):
        ...
        Args:
            sqr (Square): The Square ot print to stdout.
            method (str): The method to run on sqr.
        Returns:
            The text printed to stdout by calling method on sqr.
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
    ...
    def test_str_method_print_size(self):
        sqrt = Square(4)
        capture = TestSquare_stdout.capture_stdout(sqrt, "print")
        correct = "[Square] ({}) 0/0 - 4\n".format(sqrt.id)
        self.assertEqual(correct, capture.getvalue())

    def test_str_method_size_x(self):
        sqrt = Square(5, 5)
        correct = "[Square] ({}) 5/0 - 5".format(sqrt.id)
        self.assertEqual(correct, sqrt.__str__())

    def test_str_method_size_x_y(self):
        sqrt = Square(7, 4, 22)
        correct = "[Square] ({}) 4/22 - 7".format(sqrt.id)
        self.assertEqual(correct, str(sqrt))

    def test_str_method_size_x_y_id(self):
        sqrt = Square(2, 88, 4, 19)
        self.assertEqual("[Square] (19) 88/4 - 2", str(sqrt))
    ...
    def test_str_method_changed_attributes(self):
        ...
        sqrt.x = 8
        sqrt.y = 10
        self.assertEqual("[Square] ([4]) 8/10 - 15", str(sqrt))
    ...
    def test_display_size(self):
        sqrt = Square(2, 0, 0, 9)
        capture = TestSquare_stdout.capture_stdout(sqrt, "display")
        self.assertEqual("##\n##\n", capture.getvalue())

    def test_display_size_x(self):
        sqrt = Square(3, 1, 0, 18)
        capture = TestSquare_stdout.capture_stdout(sqrt, "display")
        self.assertEqual(" ###\n ###\n ###\n", capture.getvalue())
...
class TestSquare_update_args(unittest.TestCase):
    """Unittests for testing of the Square class update args method."""
